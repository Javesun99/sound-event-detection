...
class ConvViT(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, in_chans=4, num_classes=14, embed_dim=768, depth=12,
        ...
        self.pos_embed = nn.Parameter(torch.zeros(1,4800,embed_dim[2]))
